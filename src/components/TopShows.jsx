...
function TopShows() {
      ...
      useEffect(()=>{
        async function getTrending(){
            try{
                ...
                const response2= await fetch('https://api.themoviedb.org/3/tv/top_rated?language=en-US&page=1', options)
  ...
  return (
    <div className='flex flex-col gap-1 lg:ml-[100px] mt-10 lg:w-[calc(100vw-100px)] overflow-x-hidden' >
        <p className='ml-3 lg:ml-0 text-white font-semibold text-[20px]' >Top Rated Shows</p>
