...
function Home({hovered, hoveredMovieId, handleMouseEnter, handleMouseLeave}) {
  ...
  return (
    <div className='z-[90] relative' >
      ...
      <SeriesGenreSlider mb='120px' title='Top Rated Series' url1='https://api.themoviedb.org/3/tv/top_rated?language=en-US&page=1' url2='https://api.themoviedb.org/3/tv/top_rated?language=en-US&page=2' />
      <Footer/>
    </div>
  )
}
